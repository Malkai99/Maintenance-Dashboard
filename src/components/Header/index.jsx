...
const Header = () => {
  ...
  function getAcronym(name) {
    ...
    return <span className="font-medium text-gray-600 dark:text-gray-300">{acronym}</span>
  }

  // GET Avatar img 
  // function getAvatar(imgUrl) {
  //   return <img className="w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src={imgUrl} alt="Bordered avatar" />
  // }
  ...
  return (
    ...
    bg-blue-aqua px-5">
      <BurgerMenu />
      <h2 className={`${styles.title}`} >Mantenimiento Equipo Dashboard</h2>
