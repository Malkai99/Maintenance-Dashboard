...
const DoughnutChart = ({title, value}) => {
  ...
  return (
    <div className="card__container block w-full px-8 py-5 max-w-full lg:max-w-[400px] lg:max-h-[350px] max-h-80  h-[350px] 2xl:max-h-96 bg-white rounded-2xl shadow-cardShadow ">
